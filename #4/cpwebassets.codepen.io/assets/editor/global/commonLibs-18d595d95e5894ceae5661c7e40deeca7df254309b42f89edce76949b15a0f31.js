! function(t) {
    ...
    function e(e, n) {
        ...
        return "area" === a ? (o = (s = e.parentNode).name, !(!e.href || !o || "map" !== s.nodeName.toLowerCase()) && (!!(r = t("img[usemap='#" + o + "']")[0]) && i(r))) : (/^(input|select|textarea|button|object)$/.test(a) ? !e.disabled : "a" === a && e.href || n) && i(e)
    }
    ...
    t.ui = t.ui || {}, t.extend(t.ui, {
        ...
        focus: (r = t.fn.focus, function(e, i) {
        ...
        disableSelection: (o = "onselectstart" in document.createElement("div") ? "selectstart" : "mousedown", function() {
    ...
    t.cleanData = function(e) {
        ...
        t.fn[e] = function(s) {
            ...
            return o ? this.each((function() {
                ...
                return "instance" === s ? (a = o, !1) : o ? t.isFunction(o[s]) && "_" !== s.charAt(0) ? (i = o[s].apply(o, r)) !== o && void 0 !== i ? (a = i && i.jquery ? a.pushStack(i.get()) : i, !1) : void 0 : t.error("no such method '" + s + "' for " + e + " widget instance") : t.error("cannot call methods on " + e + " prior to initialization; attempted to call method '" + s + "'")
        ...
        _createWidget: function(e, i) {
            i = t(i || this.defaultElement || this)[0], this.element = t(i), this.uuid = a++, this.eventNamespace = "." + this.widgetName + this.uuid, this.bindings = t(), this.hoverable = t(), this.focusable = t(), i !== this && (t.data(i, this.widgetFullName, this), this._on(!0, this.element, {
                remove: function(t) {
    ...
    t.widget("ui.mouse", {
        ...
        _mouseDown: function(e) {
            if (!l) {
                ...
                return !(n && !s && this._mouseCapture(e)) || (this.mouseDelayMet = !this.options.delay, this.mouseDelayMet || (this._mouseDelayTimer = setTimeout((function() {
                    ...
                    return i._mouseUp(t)
                }, this.document.bind("mousemove." + this.widgetName, this._mouseMoveDelegate).bind("mouseup." + this.widgetName, this._mouseUpDelegate), e.preventDefault(), l = !0, !0))
            }
        },
        ...
        _mouseUp: function(e) {
            return this.document.unbind("mousemove." + this.widgetName, this._mouseMoveDelegate).unbind("mouseup." + this.widgetName, this._mouseUpDelegate), this._mouseStarted && (this._mouseStarted = !1, e.target === this._mouseDownEvent.target && t.data(e.target, this.widgetName + ".preventClickEvent", !0), this._mouseStop(e)), l = !1, !1
        },
    ...
    t.widget("ui.draggable", t.ui.mouse, {
        ...
        drag: function(e, i, n) {
            var s, o, r, a, h, l, c, u, p, d, f = n.options,
                m = f.snapTolerance,
                g = i.offset.left,
                v = g + n.helperProportions.width,
                y = i.offset.top,
                _ = y + n.helperProportions.height;
            for (p = n.snapElements.length - 1; p >= 0; p--) l = (h = n.snapElements[p].left - n.margins.left) + n.snapElements[p].width, u = (c = n.snapElements[p].top - n.margins.top) + n.snapElements[p].height, v < h - m || g > l + m || _ < c - m || y > u + m || !t.contains(n.snapElements[p].item.ownerDocument, n.snapElements[p].item) ? (n.snapElements[p].snapping && n.options.snap.release && n.options.snap.release.call(n.element, e, t.extend(n._uiHash(), {
                snapItem: n.snapElements[p].item
            })), n.snapElements[p].snapping = !1) : ("inner" !== f.snapMode && (s = Math.abs(c - _) <= m, o = Math.abs(u - y) <= m, r = Math.abs(h - v) <= m, a = Math.abs(l - g) <= m, s && (i.position.top = n._convertPositionTo("relative", {
                ...
                top: 0,
                left: l
            }).left)), d = s || o || r || a, "outer" !== f.snapMode && (s = Math.abs(c - y) <= m, o = Math.abs(u - _) <= m, r = Math.abs(h - g) <= m, a = Math.abs(l - v) <= m, s && (i.position.top = n._convertPositionTo("relative", {
                top: c,
                left: 0
            }).top), o && (i.position.top = n._convertPositionTo("relative", {
            ...
            }).left)), !n.snapElements[p].snapping && (s || o || r || a || d) && n.options.snap.snap && n.options.snap.snap.call(n.element, e, t.extend(n._uiHash(), {
                snapItem: n.snapElements[p].item
    ...
    t.widget("ui.droppable", {
        ...
        return function(e, i, n, s) {
            ...
            switch (n) {
                ...
                case "intersect":
                    return l < o + e.helperProportions.width / 2 && a - e.helperProportions.width / 2 < u && c < r + e.helperProportions.height / 2 && h - e.helperProportions.height / 2 < p;
                case "pointer":
                    return t(s.pageY, c, i.proportions().height) && t(s.pageX, l, i.proportions().width);
                case "touch":
                    return (r >= c && r <= p || h >= c && h <= p || r < c && h > p) && (o >= l && o <= u || a >= l && a <= u || o < l && a > u);
                default:
                    return !1
            }
        }
    ...
    t.widget("ui.resizable", t.ui.mouse, {
        ...
        _mouseStop: function(e) {
            this.resizing = !1;
            var i, n, s, o, r, a, h, l = this.options,
                c = this;
            ...
            }, a = parseInt(c.element.css("left"), 10) + (c.position.left - c.originalPosition.left) || null, h = parseInt(c.element.css("top"), 10) + (c.position.top - c.originalPosition.top) || null, l.animate || this.element.css(t.extend(r, {
                top: h,
                left: a
        ...
        _respectSize: function(t) {
            var e = this._vBoundaries,
                ...
                l = /sw|nw|w/.test(i),
                c = /nw|ne|n/.test(i);
            return o && (t.width = e.minWidth), r && (t.height = e.minHeight), n && (t.width = e.maxWidth), s && (t.height = e.maxHeight), o && l && (t.left = a - e.minWidth), n && l && (t.left = a - e.maxWidth), r && c && (t.top = h - e.minHeight), s && c && (t.top = h - e.maxHeight), t.width || t.height || t.left || !t.top ? t.width || t.height || t.top || !t.left || (t.left = null) : t.top = null, t
        },
        ...
        start: function() {
            var e, i, n, s, o, r, a, h = t(this).resizable("instance"),
                l = h.options,
                c = h.element,
                u = l.containment,
            ...
            }, n = h.containerOffset, s = h.containerSize.height, o = h.containerSize.width, r = h._hasScroll(p, "left") ? p.scrollWidth : o, a = h._hasScroll(p) ? p.scrollHeight : s, h.parentData = {
                element: p,
                left: n.left,
                top: n.top,
                width: r,
        ...
        resize: function(e, i) {
            ...
            "object" != typeof s.alsoResize || s.alsoResize.nodeType ? h(s.alsoResize) : t.each(s.alsoResize, (function(t, e) {
                h(t, e)
            }))
        },
        stop: function() {
    ...
    t.ui.resizable, t.widget("ui.sortable", t.ui.mouse, {
        ...
        _getItemsAsjQuery: function(e) {
            ...
            if (l && e)
                for (n = l.length - 1; n >= 0; n--)
                    for (s = (o = t(l[n], this.document[0])).length - 1; s >= 0; s--)(r = t.data(o[s], this.widgetFullName)) && r !== this && !r.options.disabled && h.push([t.isFunction(r.options.items) ? r.options.items.call(r.element) : t(r.options.items, r.element).not(".ui-sortable-helper").not(".ui-sortable-placeholder"), r]);
            for (h.push([t.isFunction(this.options.items) ? this.options.items.call(this.element, null, {
                    options: this.options,
                    item: this.currentItem
                }) : t(this.options.items, this.element).not(".ui-sortable-helper").not(".ui-sortable-placeholder"), this]), n = h.length - 1; n >= 0; n--) h[n][0].each(i);
            return t(a)
        },
        ...
        _refreshItems: function(e) {
            ...
            var i, n, s, o, r, a, h, l, c = this.items,
                u = [
            ...
            if (p && this.ready)
                for (i = p.length - 1; i >= 0; i--)
                    for (n = (s = t(p[i], this.document[0])).length - 1; n >= 0; n--)(o = t.data(s[n], this.widgetFullName)) && o !== this && !o.options.disabled && (u.push([t.isFunction(o.options.items) ? o.options.items.call(o.element[0], e, {
                        item: this.currentItem
                    }) : t(o.options.items, o.element), o]), this.containers.push(o));
            for (i = u.length - 1; i >= 0; i--)
                for (r = u[i][1], n = 0, l = (a = u[i][0]).length; n < l; n++)(h = t(a[n])).data(this.widgetName + "-item", r), c.push({
                    item: h,
                    instance: r,
                    width: 0,
                    height: 0,
        ...
        _contactContainers: function(e) {
            var i, n, s, o, r, a, h, l, c, u, p = null,
                d = null;
            ...
            if (p)
                if (1 === this.containers.length) this.containers[d].containerCache.over || (this.containers[d]._trigger("over", e, this._uiHash(this)), this.containers[d].containerCache.over = 1);
                    ...
                    for (s = 1e4, o = null, r = (c = p.floating || this._isFloating(this.currentItem)) ? "left" : "top", a = c ? "width" : "height", u = c ? "clientX" : "clientY", n = this.items.length - 1; n >= 0; n--) t.contains(this.containers[d].element[0], this.items[n].item[0]) && this.items[n].item[0] !== this.currentItem[0] && (h = this.items[n].item.offset()[r], l = !1, e[u] - h > this.items[n][a] / 2 && (l = !0), Math.abs(e[u] - h) < s && (s = Math.abs(e[u] - h), o = this.items[n], this.direction = l ? "up" : "down"));
...
function() {
    ...
    function(t, e) {
        ...
        s.prototype = new e, s.prototype.bindStartEvent = function(t) {
            ...
            var s = (n = void 0 === n || !!n) ? "bind" : "unbind";
        ...
        return s.prototype._bindPostStartEvents = function(e) {
            if (e) {
                for (var n = o[e.type], s = e.preventDefault ? t : document, r = 0, a = n.length; r < a; r++) {
                    var h = n[r];
                    i.bind(s, h, this)
                }
    ...
    function(t, e) {
        "use strict";
        "function" == typeof define && define.amd ? define(["eventie/eventie", "unipointer/unipointer"], (function(i, n) {
            return e(t, i, n)
        ...
        o.prototype._bindHandles = function(t) {
            var i;
            t = void 0 === t || !!t, i = a.pointerEnabled ? function(e) {
            ...
            for (var n = t ? "bind" : "unbind", s = 0, o = this.handles.length; s < o; s++) {
                var r = this.handles[s];
                this._bindStartEvent(r, t), i(r), e[n](r, "click", this)
            }
        };
        var h = "attachEvent" in document.documentElement ? function(t) {
        ...
        o.prototype.pointerDown = function(i, n) {
            ...
            s && s.blur && s.blur(), this._bindPostStartEvents(i), this.pointerDownScroll = o.getScrollPosition(), e.bind(t, "scroll", this), this.emitEvent("pointerDown", [i, n])
    ...
    function(t) {
        var e;
        "undefined" != typeof window ? e = window : "undefined" != typeof self && (e = self), e.ALGOLIA_MIGRATION_LAYER = t()
    }((function() {
        return function t(e, i, n) {
            ...
            1: [function(t, e) {
                ...
                e.exports = function(t, e, o) {
                    ...
                    "function" == typeof e && (o = e, e = {}), e = e || {}, o = o || function() {}, a.type = e.type || "text/javascript", a.charset = e.charset || "utf8", a.async = !("async" in e) || !!e.async, a.src = t, e.attrs && i(a, e.attrs), e.text && (a.text = "" + e.text), ("onload" in a ? n : s)(a, o), a.onload || n(a, o), r.appendChild(a)
                }
            }, {}],
            2: [function(t, e) {
                "use strict";
                ...
                function i(t) {
                    for (var e = new RegExp("cdn\\.jsdelivr\\.net/algoliasearch/latest/" + t.replace(".", "\\.") + "(?:\\.min)?\\.js$"), i = document.getElementsByTagName("script"), n = !1, s = 0, o = i.length; s < o; s++)
            ...
            3: [function(t, e) {
                ...
                function i(e) {
                    ...
                    try {
                        document.write("<script>window.ALGOLIA_SUPPORTS_DOCWRITE = true</script>"), !0 === window.ALGOLIA_SUPPORTS_DOCWRITE ? (document.write('<script src="' + s + '"></script>'), n("document.write")()) : i(s, n("DOMElement"))
                    } catch (t) {
                        i(s, n("DOMElement"))
                    }
                }
        ...
        return function t(e, i, n) {
            ...
            1: [function(t, e, i) {
                (function(n) {
                    ...
                    }(i = e.exports = t(2)).log = r, i.formatArgs = o, i.save = a, i.load = h, i.useColors = s, i.storage = "undefined" != typeof chrome && void 0 !== chrome.storage ? chrome.storage.local : l(), i.colors = ["lightseagreen", "forestgreen", "goldenrod", "dodgerblue", "darkorchid", "crimson"], i.formatters.j = function(t) {
                        try {
            ...
            2: [function(t, e, i) {
                    ...
                    function e() {
                        if (e.enabled) {
                            ...
                            o[0] = o[0].replace(/%([a-zA-Z%])/g, (function(e, n) {
                                ...
                                return e
                            })), i.formatArgs.call(t, o), (e.log || i.log || console.log.bind(console)).apply(t, o)
                        }
                    }
                    return e.namespace = t, e.enabled = i.enabled(t), e.useColors = i.useColors(), e.color = n(t), "function" == typeof i.init && i.init(e), e
                }

                function o(t) {
                    i.save(t), i.names = [], i.skips = [];
                    for (var e = ("string" == typeof t ? t : "").split(/[\s,]+/), n = e.length, s = 0; s < n; s++) e[s] && ("-" === (t = e[s].replace(/\*/g, ".*?"))[0] ? i.skips.push(new RegExp("^" + t.substr(1) + "$")) : i.names.push(new RegExp("^" + t + "$")))
                }
                ...
                var l;
                (i = e.exports = s.debug = s.default = s).coerce = h, i.disable = r, i.enable = o, i.enabled = a, i.humanize = t(9), i.names = [], i.skips = [], i.formatters = {}
            }, {
                9: 9
            }],
            3: [function(e, i, n) {
                (function(s, o) {
                    ! function(e, s) {
                        "object" == typeof n && void 0 !== i ? i.exports = s() : "function" == typeof t && t.amd ? t(s) : e.ES6Promise = s()
                    }(this, (function() {
                        "use strict";
                        ...
                        function p() {
                            for (var t = 0; t < V; t += 2) {
                                (0, it[t])(it[t + 1]), it[t] = void 0, it[t + 1] = void 0
                            }
                            V = 0
                        }
                        ...
                        function x(t, e) {
                            e._state === rt ? S(t, e._result) : e._state === at ? I(t, e._result) : E(e, void 0, (function(e) {
                                return C(t, e)
                            }), (function(e) {
                                return I(t, e)
                            }))
                        ...
                        function P(t, e, n) {
                            e.constructor === t.constructor && n === f && e.constructor.resolve === m ? x(t, e) : n === ht ? (I(t, ht.error), ht.error = null) : void 0 === n ? S(t, e) : i(n) ? w(t, e, n) : S(t, e)
                        }
                        ...
                        function S(t, e) {
                            t._state === ot && (t._result = e, t._state = rt, 0 !== t._subscribers.length && Y(A, t))
                        }

                        function I(t, e) {
                            t._state === ot && (t._state = at, t._result = e, Y(T, t))
                        }

                        function E(t, e, i, n) {
                            var s = t._subscribers,
                                o = s.length;
                            t._onerror = null, s[o] = e, s[o + rt] = i, s[o + at] = n, 0 === o && t._state && Y(A, t)
                        }
                        ...
                        function A(t) {
                            var e = t._subscribers,
                                i = t._state;
                            if (0 !== e.length) {
                                for (var n = void 0, s = void 0, o = t._result, r = 0; r < e.length; r += 3) n = e[r], s = e[r + i], n ? O(i, n, s, o) : s(o);
                        ...
                        function O(t, e, n, s) {
                            var o = i(n),
                                ...
                                l = void 0;
                            if (o) {
                                if ((r = k(n, s)) === lt ? (l = !0, a = r.error, r.error = null) : h = !0, e === r) return void I(e, y())
                            } else r = s, h = !0;
                            e._state !== ot || (o && h ? C(e, r) : l ? I(e, a) : t === rt ? S(e, r) : t === at && I(e, r))
                        }
                        ...
                        function j(t) {
                            t[st] = ct++, t._state = void 0, t._result = void 0, t._subscribers = []
                        }

                        function z(t, e) {
                            this._instanceConstructor = t, this.promise = new t(g), this.promise[st] || j(this.promise), B(e) ? (this.length = e.length, this._remaining = e.length, this._result = new Array(this.length), 0 === this.length ? S(this.promise, this._result) : (this.length = this.length || 0, this._enumerate(e), 0 === this._remaining && S(this.promise, this._result))) : I(this.promise, H())
                        }
                        ...
                        function U(t) {
                            var e = this;
                            return new e(B(t) ? function(i, n) {
                                for (var s = t.length, o = 0; o < s; o++) e.resolve(t[o]).then(i, n)
                            } : function(t, e) {
                        ...
                        function W(t) {
                            this[st] = N(), this._result = this._state = void 0, this._subscribers = [], g !== t && ("function" != typeof t && q(), this instanceof W ? D(this, t) : $())
                        }
                        ...
                        var B = K,
                            ...
                            Q = void 0,
                            Y = function(t, e) {
                                it[V] = t, it[V + 1] = e, 2 === (V += 2) && (Q ? Q(p) : nt())
                            },
                            J = "undefined" != typeof window ? window : void 0,
                            G = J || {},
                            Z = G.MutationObserver || G.WebKitMutationObserver,
                            tt = "undefined" == typeof self && void 0 !== s && "[object process]" === {}.toString.call(s),
                            et = "undefined" != typeof Uint8ClampedArray && "undefined" != typeof importScripts && "undefined" != typeof MessageChannel,
                            it = new Array(1e3),
                            nt = void 0;
                        nt = tt ? a() : Z ? l() : et ? c() : void 0 === J && "function" == typeof e ? d() : u();
                        var st = Math.random().toString(36).substring(16),
                            ot = void 0,
                            rt = 1,
                            at = 2,
                            ht = new R,
                            lt = new R,
                            ct = 0;
                        return z.prototype._enumerate = function(t) {
                            ...
                            if (n === m) {
                                var s = _(t);
                                if (s === f && t._state !== ot) this._settledAt(t._state, e, t._result);
                            ...
                            var n = this.promise;
                            n._state === ot && (this._remaining--, t === at ? I(n, i) : this._result[e] = i), 0 === this._remaining && S(n, this._result)
                        ...
                        }, W.all = L, W.race = U, W.resolve = m, W.reject = M, W._setScheduler = n, W._setAsap = r, W._asap = Y, W.prototype = {
                            constructor: W,
                            then: f,
                            catch: function(t) {
                                return this.then(null, t)
                            }
                        }, W.polyfill = F, W.Promise = W, W
                    }))
            ...
            4: [function(t, e) {
                ...
                e.exports = i, i.EventEmitter = i, i.prototype._events = void 0, i.prototype._maxListeners = void 0, i.defaultMaxListeners = 10, i.prototype.setMaxListeners = function(t) {
                    ...
                    if (n(i)) switch (arguments.length) {
                        ...
                        for (a = Array.prototype.slice.call(arguments, 1), s = (l = i.slice()).length, h = 0; h < s; h++) l[h].apply(this, a);
                    return !0
                }, i.prototype.addListener = function(t, e) {
                    var s;
                    if (!n(e)) throw TypeError("listener must be a function");
                    return this._events || (this._events = {}), this._events.newListener && this.emit("newListener", t, n(e.listener) ? e.listener : e), this._events[t] ? o(this._events[t]) ? this._events[t].push(e) : this._events[t] = [this._events[t], e] : this._events[t] = e, o(this._events[t]) && !this._events[t].warned && ((s = r(this._maxListeners) ? i.defaultMaxListeners : this._maxListeners) && s > 0 && this._events[t].length > s && (this._events[t].warned = !0, console.error("(node) warning: possible EventEmitter memory leak detected. %d listeners added. Use emitter.setMaxListeners() to increase limit.", this._events[t].length), "function" == typeof console.trace && console.trace())), this
                }, i.prototype.on = i.prototype.addListener, i.prototype.once = function(t, e) {
                    function i() {
                        this.removeListener(t, i), s || (s = !0, e.apply(this, arguments))
                    }
                    if (!n(e)) throw TypeError("listener must be a function");
                    var s = !1;
                    ...
                    if (r = (i = this._events[t]).length, s = -1, i === e || n(i.listener) && i.listener === e) delete this._events[t], this._events.removeListener && this.emit("removeListener", t, e);
                    else if (o(i)) {
                        for (a = r; a-- > 0;)
            ...
            5: [function(t, e) {
                ...
                e.exports = function(t, e, s) {
                    ...
                    var o = t.length;
                    if (o === +o)
                        for (var r = 0; r < o; r++) e.call(s, t[r], r, t);
                    else
                        for (var a in t) i.call(t, a) && e.call(s, t[a], a, t)
                }
            }, {}],
            6: [function(t, e) {
                (function(t) {
            ...
            9: [function(t, e) {
                ...
                function n(t) {
                    return t >= l ? Math.round(t / l) + "d" : t >= h ? Math.round(t / h) + "h" : t >= a ? Math.round(t / a) + "m" : t >= r ? Math.round(t / r) + "s" : t + "ms"
                }

                function s(t) {
                    return o(t, l, "day") || o(t, h, "hour") || o(t, a, "minute") || o(t, r, "second") || t + " ms"
                }
                ...
                e.exports = function(t, e) {
                    ...
                    if ("number" === o && !1 === isNaN(t)) return e.long ? s(t) : n(t);
                ...
                var i = Object.prototype.hasOwnProperty,
                    ...
                    p = function() {
                        ...
                        for (var t in window) try {
                            if (!u["$" + t] && i.call(window, t) && null !== window[t] && "object" == typeof window[t]) try {
                                c(window[t])
                            } catch (t) {
                                return !0
                            }
                    ...
                    f = function(t) {
                        var e = null !== t && "object" == typeof t,
                            ...
                            u = [];
                        if (!e && !s && !r) throw new TypeError("Object.keys called on a non-object");
                        var p = h && s;
                        ...
                        if (r && t.length > 0)
                            ...
                            for (var g in t) p && "prototype" === g || !i.call(t, g) || u.push(String(g));
                        if (a)
                            for (var v = d(t), y = 0; y < l.length; ++y) v && "constructor" === l[y] || !i.call(t, l[y]) || u.push(l[y]);
                        return u
                    };
                f.shim = function() {
                    if (Object.keys) {
            ...
            12: [function(t, e) {
                ...
                }, p.title = "browser", p.browser = !0, p.env = {}, p.argv = [], p.version = "", p.versions = {}, p.on = l, p.addListener = l, p.once = l, p.off = l, p.removeListener = l, p.removeAllListeners = l, p.emit = l, p.binding = function() {
            ...
            14: [function(t, e) {
                ...
                var s = t(16),
                    ...
                    h = t(7),
                    l = t(27);
                h(i, a), i.prototype.deleteIndex = function(t, e) {
                    ...
                    else if (void 0 !== i) throw new Error("the scope given to `copyIndex` was not an array with settings, synonyms or rules");
                    return this._jsonRequest({
                        method: "POST",
                        url: "/1/indexes/" + encodeURIComponent(t) + "/operation",
                        body: s,
                    ...
                    var s = t(24),
                        o = {};
                    return "object" == typeof e ? (o = s(e), n = i) : 0 === arguments.length || "function" == typeof e ? n = e : 1 === arguments.length || "function" == typeof i ? (n = i, o.offset = e) : (o.offset = e, o.length = i), void 0 === o.offset && (o.offset = 0), void 0 === o.length && (o.length = 10), this._jsonRequest({
                        method: "GET",
                    ...
                    var i = "";
                    return void 0 === t || "function" == typeof t ? e = t : i = "?page=" + t, this._jsonRequest({
                        method: "GET",
                        url: "/1/indexes" + i,
                        hostType: "read",
                        callback: e
                ...
                }), r("client.listUserKeys()", "client.listApiKeys()")), i.prototype.listApiKeys = function(t) {
                    return this._jsonRequest({
                        method: "GET",
                        url: "/1/keys",
                        hostType: "read",
                ...
                }), r("client.getUserKeyACL()", "client.getApiKey()")), i.prototype.getApiKey = function(t, e) {
                    return this._jsonRequest({
                        method: "GET",
                        url: "/1/keys/" + t,
                        hostType: "read",
                ...
                }), r("client.deleteUserKey()", "client.deleteApiKey()")), i.prototype.deleteApiKey = function(t, e) {
                    return this._jsonRequest({
                        method: "DELETE",
                        url: "/1/keys/" + t,
                        hostType: "write",
                ...
                }), r("client.addUserKey()", "client.addApiKey()")), i.prototype.addApiKey = function(e, i, n) {
                    var s = "Usage: client.addApiKey(arrayOfAcls[, params, callback])";
                    if (!t(8)(e)) throw new Error(s);
                    1 !== arguments.length && "function" != typeof i || (n = i, i = null);
                    var o = {
                        acl: e
                    };
                    return i && (o.validity = i.validity, o.maxQueriesPerIPPerHour = i.maxQueriesPerIPPerHour, o.maxHitsPerQuery = i.maxHitsPerQuery, o.indexes = i.indexes, o.description = i.description, i.queryParameters && (o.queryParameters = this._getSearchParams(i.queryParameters, "")), o.referers = i.referers), this._jsonRequest({
                        method: "POST",
                        url: "/1/keys",
                        body: o,
                        hostType: "write",
                    ...
                    return this.addApiKey(t, e, i)
                }), r("client.addUserKeyWithValidity()", "client.addApiKey()")), i.prototype.updateUserKey = o((function(t, e, i, n) {
                    return this.updateApiKey(t, e, i, n)
                }), r("client.updateUserKey()", "client.updateApiKey()")), i.prototype.updateApiKey = function(e, i, n, s) {
                    var o = "Usage: client.updateApiKey(key, arrayOfAcls[, params, callback])";
                    if (!t(8)(i)) throw new Error(o);
                    2 !== arguments.length && "function" != typeof n || (s = n, n = null);
                    var r = {
                        acl: i
                    };
                    return n && (r.validity = n.validity, r.maxQueriesPerIPPerHour = n.maxQueriesPerIPPerHour, r.maxHitsPerQuery = n.maxHitsPerQuery, r.indexes = n.indexes, r.description = n.description, n.queryParameters && (r.queryParameters = this._getSearchParams(n.queryParameters, "")), r.referers = n.referers), this._jsonRequest({
                        method: "PUT",
                        url: "/1/keys/" + e,
                        body: r,
                        hostType: "write",
                    ...
                    this._batch = []
                }), r("client.startQueriesBatch()", "client.search()")), i.prototype.addQueryInBatch = o((function(t, e, i) {
                    this._batch.push({
                        indexName: t,
                        query: e,
                        params: i
                    })
                }), r("client.addQueryInBatch()", "client.search()")), i.prototype.sendQueriesBatch = o((function(t) {
                    return this.search(this._batch, t)
                }), r("client.sendQueriesBatch()", "client.search()")), i.prototype.batch = function(e, i) {
                    ...
                    if (!t.userID || !t.cluster) throw new l.AlgoliaSearchError("You have to provide both a userID and cluster", t);
                    return this._jsonRequest({
                        method: "POST",
                    ...
                    if (!t.userID) throw new l.AlgoliaSearchError("You have to provide a userID", {
                        debugData: t
                    });
                    return this._jsonRequest({
                        method: "GET",
                ...
                }, i.prototype.destroy = n, i.prototype.enableRateLimitForward = n, i.prototype.disableRateLimitForward = n, i.prototype.useSecuredAPIKey = n, i.prototype.disableSecuredAPIKey = n, i.prototype.generateSecuredApiKey = n
            }, {
                15: 15,
                16: 16,
                24: 24,
            ...
            15: [function(t, e) {
                (function(i) {
                    function n(e, i, n) {
                        ...
                        if (!0 !== n._allowEmptyCredentials && !e) throw new h.AlgoliaSearchError("Please provide an application ID. " + c);
                        if (!0 !== n._allowEmptyCredentials && !i) throw new h.AlgoliaSearchError("Please provide an API key. " + c);
                        this.applicationID = e, this.apiKey = i, this.hosts = {
                            read: [],
                            write: []
                        ...
                        if (/:$/.test(u) || (u += ":"), "http:" !== u && "https:" !== u) throw new h.AlgoliaSearchError("protocol must be `http:` or `https:` (was `" + n.protocol + "`)");
                        if (this._checkAppIdData(), n.hosts) a(n.hosts) ? (this.hosts.read = r(n.hosts), this.hosts.write = r(n.hosts)) : (this.hosts.read = r(n.hosts.read), this.hosts.write = r(n.hosts.write));
                        else {
                        ...
                        this.hosts.read = l(this.hosts.read, s(u)), this.hosts.write = l(this.hosts.write, s(u)), this.extraHeaders = {}, this.cache = n._cache || {}, this._ua = n._ua, this._useCache = !(void 0 !== n._useCache && !n._cache) || n._useCache, this._useFallback = void 0 === n.useFallback || n.useFallback, this._setTimeout = n._setTimeout, o("init done, %j", this)
                    }
                    ...
                    function a(t) {
                        ...
                        for (var i in t)
                            if (Object.prototype.hasOwnProperty.call(t, i)) {
                                var n;
                                n = "x-algolia-api-key" === i || "x-algolia-application-id" === i ? "**hidden for security purposes**" : t[i], e[i] = n
                            }
                        return e
                    }
                    e.exports = n;
                    var h = t(27),
                        ...
                        u = t(33),
                        p = 500,
                        d = i.env.RESET_APP_DATA_TIMER && parseInt(i.env.RESET_APP_DATA_TIMER, 10) || 12e4;
                    n.prototype.initIndex = function(t) {
                        ...
                        function i(t, l) {
                            function p(t) {
                                ...
                                r("received response: statusCode: %s, computed statusCode: %d, headers: %j", t.statusCode, e, t.headers);
                                ...
                                if (v.push({
                                        ...
                                        duration: o - x,
                                        statusCode: e
                                    }), i) return d._useCache && u && (u[w] = t.responseText), t.body;
                                if (4 !== Math.floor(e / 100)) return f += 1, _();
                                r("unrecoverable error");
                                var c = new h.AlgoliaSearchError(t.body && t.body.message, {
                                    debugData: v,
                                    statusCode: e
                                });
                            ...
                            function y(t) {
                                ...
                                return v.push({
                                    ...
                                    endTime: i,
                                    duration: i - x
                                }), t instanceof h.AlgoliaSearchError || (t = new h.Unknown(t && t.message, t)), f += 1, t instanceof h.Unknown || t instanceof h.UnparsableJSON || f >= d.hosts[e.hostType].length && (m || !g) ? (t.debugData = v, d._promise.reject(t)) : t instanceof h.RequestTimeout ? b() : _()
                            }

                            function _() {
                                return r("retrying request"), d._incrementHostIndex(e.hostType), i(t, l)
                            }

                            function b() {
                                return r("retrying request with higher timeout"), d._incrementHostIndex(e.hostType), d._incrementTimeoutMultipler(), l.timeouts = d._getTimeoutsForRequest(e.hostType), i(t, l)
                            }
                            d._checkAppIdData();
                            var w, x = new Date;
                            if (d._useCache && (w = e.url), d._useCache && n && (w += "_body_" + l.body), d._useCache && u && void 0 !== u[w]) return r("serving response from cache"), d._promise.resolve(JSON.parse(u[w]));
                            if (f >= d.hosts[e.hostType].length) return !g || m ? (r("could not get any response"), d._promise.reject(new h.AlgoliaSearchError("Cannot connect to the AlgoliaSearch API. Send an email to support@algolia.com to report and resolve the issue. Application id was: " + d.applicationID, {
                                debugData: v
                            }))) : (r("switching to fallback"), f = 0, l.method = e.fallback.method, l.url = e.fallback.url, l.jsonBody = e.fallback.body, l.jsonBody && (l.body = o(l.jsonBody)), s = d._computeRequestHeaders({
                                additionalUA: c,
                                headers: e.headers
                            }), l.timeouts = d._getTimeoutsForRequest(e.hostType), d._setHostIndexByType(0, e.hostType), m = !0, i(d._request.fallback, l));
                            ...
                            return r("method: %s, url: %s, headers: %j, timeouts: %d", T.method, C, T.headers, T.timeouts), t === d._request.fallback && r("using fallback"), t.call(d, C, T).then(p, y)
                        }
                        this._checkAppIdData();
                        var n, s, r = t(1)("algoliasearch:" + e.url),
                            c = e.additionalUA || "",
                            u = e.cache,
                            d = this,
                            f = 0,
                        ...
                        this.apiKey.length > p && void 0 !== e.body && (void 0 !== e.body.params || void 0 !== e.body.requests) ? (e.body.apiKey = this.apiKey, s = this._computeRequestHeaders({
                            additionalUA: c,
                            withApiKey: !1,
                            headers: e.headers
                            ...
                            additionalUA: c,
                            headers: e.headers
                        }), void 0 !== e.body && (n = o(e.body)), r("request start");
                        var v = [],
                            y = i(d._request, {
                                url: e.url,
                                method: e.method,
                        ...
                        if (null == t) return e;
                        for (var i in t) null !== i && void 0 !== t[i] && t.hasOwnProperty(i) && (e += "" === e ? "" : "&", e += i + "=" + encodeURIComponent("[object Array]" === Object.prototype.toString.call(t[i]) ? o(t[i]) : t[i]));
                        return e
                        ...
                        return !1 !== e.withApiKey && (n["x-algolia-api-key"] = this.apiKey), this.userToken && (n["x-algolia-usertoken"] = this.userToken), this.securityTags && (n["x-algolia-tagfilters"] = this.securityTags), i(this.extraHeaders, (function(t, e) {
                            n[e] = t
                        })), e.headers && i(e.headers, (function(t, e) {
                            n[e] = t
                        })), n
                        ...
                        "function" == typeof i ? (n = i, i = {}) : void 0 === i && (i = {});
                        var a = this,
                            h = {
                            ...
                            c = "/1/indexes/*/queries";
                        return void 0 !== i.strategy && (c += "?strategy=" + i.strategy), this._jsonRequest({
                            cache: this.cache,
                            method: "POST",
                            url: c,
                            body: h,
                        ...
                        if ("[object Array]" === Object.prototype.toString.call(t)) {
                            for (var e = [], i = 0; i < t.length; ++i)
                                if ("[object Array]" === Object.prototype.toString.call(t[i])) {
                                    for (var n = [], s = 0; s < t[i].length; ++s) n.push(t[i][s]);
                                    e.push("(" + n.join(",") + ")")
                                } else e.push(t[i]);
                            t = e.join(",")
                        }
                        ...
                        var t = this._getAppIdData(),
                            e = (new Date).getTime();
                        return null === t || e - t.lastChange > d ? this._resetInitialAppIdData(t) : t
                    }, n.prototype._resetInitialAppIdData = function(t) {
                        var e = t || {};
                        return e.hostIndexes = {
                            read: 0,
                            write: 0
                        }, e.timeoutMultiplier = 1, e.shuffleResult = e.shuffleResult || r([1, 2, 3]), this._setAppIdData(e)
                        ...
                        return n[i] = e, this._partialAppIdDataUpdate({
                            hostIndexes: n
                        }), e
            ...
            16: [function(t, e) {
                ...
                e.exports = i, s(i, o), i.prototype.addObject = function(t, e, i) {
                    var n = this;
                    return 1 !== arguments.length && "function" != typeof e || (i = e, e = void 0), this.as._jsonRequest({
                        method: void 0 !== e ? "PUT" : "POST",
                        url: "/1/indexes/" + encodeURIComponent(n.indexName) + (void 0 !== e ? "/" + encodeURIComponent(e) : ""),
                        body: t,
                        hostType: "write",
                        callback: i
                    })
                    ...
                    1 !== arguments.length && "function" != typeof e || (i = e, e = void 0);
                    var n = "/1/indexes/" + encodeURIComponent(this.indexName) + "/" + encodeURIComponent(t.objectID) + "/partial";
                    return !1 === e && (n += "?createIfNotExists=false"), this.as._jsonRequest({
                        method: "POST",
                        url: n,
                        body: t,
                        hostType: "write",
                    ...
                    1 !== arguments.length && "function" != typeof i || (n = i, i = !0);
                    var s = "Usage: index.partialUpdateObjects(arrayOfObjects[, callback])";
                    if (!t(8)(e)) throw new Error(s);
                    for (var o = this, r = {
                            requests: []
                        }, a = 0; a < e.length; ++a) {
                        var h = {
                            action: !0 === i ? "partialUpdateObject" : "partialUpdateObjectNoCreate",
                    ...
                    return this.as._jsonRequest({
                        method: "PUT",
                        url: "/1/indexes/" + encodeURIComponent(i.indexName) + "/" + encodeURIComponent(t.objectID),
                        body: t,
                        hostType: "write",
                        callback: e
                    })
                    ...
                    if ("function" == typeof t || "string" != typeof t && "number" != typeof t) {
                        var i = new l.AlgoliaSearchError("Cannot delete an object without an objectID");
                        return "function" == typeof(e = t) ? e(i) : this.as._promise.reject(i)
                    }
                    var n = this;
                    return this.as._jsonRequest({
                        method: "DELETE",
                    ...
                    return this.as._jsonRequest({
                        method: "POST",
                        url: "/1/indexes/" + encodeURIComponent(r.indexName) + "/batch",
                        body: a,
                        hostType: "write",
                        callback: i
                    })
                    ...
                    function s(t) {
                        ...
                        return p.deleteObjects(e).then(o).then(r)
                    }
                    ...
                    var c = t(24),
                        ...
                        p = this,
                        d = p.as;
                    1 === arguments.length || "function" == typeof i ? (n = i, i = {}) : i = c(i), i.attributesToRetrieve = "objectID", i.hitsPerPage = 1e3, i.distinct = !1, this.clearCache();
                    var f = this.search(e, i).then(s);
                    return n ? void f.then(a, l) : f
                }), a("index.deleteByQuery()", "index.deleteBy()")), i.prototype.deleteBy = function(t, e) {
                    var i = this;
                    return this.as._jsonRequest({
                        method: "POST",
                        url: "/1/indexes/" + encodeURIComponent(i.indexName) + "/deleteByQuery",
                        body: {
                            params: i.as._getSearchParams(t, "")
                        },
                        hostType: "write",
                        callback: e
                    })
                    ...
                    function n(t) {
                        var e;
                        r._stopped || (e = void 0 !== t ? {
                            cursor: t
                        } : {
                            params: l
                        }, a._jsonRequest({
                            method: "POST",
                            url: "/1/indexes/" + encodeURIComponent(h.indexName) + "/browse",
                            hostType: "read",
                            body: e,
                            callback: s
                        }))
                    ...
                    function s(t, e) {
                        if (!r._stopped) return t ? void r._error(t) : (r._result(e), void 0 === e.cursor ? void r._end() : void n(e.cursor))
                    }
                    ...
                    return function(i, n, s) {
                        var o;
                        o = "function" == typeof s ? s : n, e.search(i, t, (function(t, e) {
                            return t ? void o(t) : void o(e.hits)
                        }))
                    }
                }), "ttAdapter is not necessary anymore and will be removed in the next version,\nhave a look at autocomplete.js (https://github.com/algolia/autocomplete.js)"), i.prototype.waitTask = function(t, e) {
                    function i() {
                        return c._jsonRequest({
                            method: "GET",
                            hostType: "read",
                            url: "/1/indexes/" + encodeURIComponent(l.indexName) + "/task/" + t
                        }).then((function(t) {
                            a++;
                            var e = o * a * a;
                            return e > r && (e = r), "published" !== t.status ? c._promise.delay(e).then(i) : t
                        }))
                    }
                    ...
                    return this.as._jsonRequest({
                        method: "GET",
                        url: "/1/indexes/" + i + "/settings?getVersion=2" + (t.advanced ? "&advanced=" + t.advanced : ""),
                        hostType: "read",
                        callback: e
                    })
                    ...
                    "function" == typeof e ? (i = e, e = {}) : void 0 === e && (e = {}), void 0 !== e.forwardToSlaves && c();
                    var n = e.forwardToSlaves || e.forwardToReplicas ? "true" : "false";
                    return this.as._jsonRequest({
                        method: "PUT",
                        url: "/1/indexes/" + encodeURIComponent(this.indexName) + "/synonyms/" + encodeURIComponent(t.objectID) + "?forwardToReplicas=" + n,
                        body: t,
                        hostType: "write",
                        callback: i
                    })
                    ...
                    return this.as._jsonRequest({
                        method: "DELETE",
                        url: "/1/indexes/" + encodeURIComponent(this.indexName) + "/synonyms/" + encodeURIComponent(t) + "?forwardToReplicas=" + n,
                        hostType: "write",
                        callback: i
                    })
                }, i.prototype.clearSynonyms = function(t, e) {
                    "function" == typeof t ? (e = t, t = {}) : void 0 === t && (t = {}), void 0 !== t.forwardToSlaves && c();
                    var i = t.forwardToSlaves || t.forwardToReplicas ? "true" : "false";
                    return this.as._jsonRequest({
                        method: "POST",
                        url: "/1/indexes/" + encodeURIComponent(this.indexName) + "/synonyms/clear?forwardToReplicas=" + i,
                        hostType: "write",
                        callback: e
                    })
                    ...
                    return this.as._jsonRequest({
                        method: "POST",
                        url: "/1/indexes/" + encodeURIComponent(this.indexName) + "/synonyms/batch?forwardToReplicas=" + n + "&replaceExistingSynonyms=" + (e.replaceExistingSynonyms ? "true" : "false"),
                        hostType: "write",
                        body: t,
                        callback: i
                    })
                    ...
                    "function" == typeof e ? (i = e, e = {}) : void 0 === e && (e = {});
                    var n = !0 === e.forwardToReplicas ? "true" : "false";
                    return this.as._jsonRequest({
                        method: "PUT",
                        url: "/1/indexes/" + encodeURIComponent(this.indexName) + "/rules/" + encodeURIComponent(t.objectID) + "?forwardToReplicas=" + n,
                        body: t,
                        hostType: "write",
                        callback: i
                    })
                    ...
                    return this.as._jsonRequest({
                        method: "DELETE",
                        url: "/1/indexes/" + encodeURIComponent(this.indexName) + "/rules/" + encodeURIComponent(t) + "?forwardToReplicas=" + n,
                        hostType: "write",
                        callback: i
                    })
                    ...
                    return this.as._jsonRequest({
                        method: "POST",
                        url: "/1/indexes/" + encodeURIComponent(this.indexName) + "/rules/clear?forwardToReplicas=" + i,
                        hostType: "write",
                        callback: e
                    })
                    ...
                    return this.as._jsonRequest({
                        method: "POST",
                        url: "/1/indexes/" + encodeURIComponent(this.indexName) + "/rules/batch?forwardToReplicas=" + n + "&clearExistingRules=" + (!0 === e.clearExistingRules ? "true" : "false"),
                        hostType: "write",
                        body: t,
                        callback: i
                    })
                }, i.prototype.setSettings = function(t, e, i) {
                    1 !== arguments.length && "function" != typeof e || (i = e, e = {}), void 0 !== e.forwardToSlaves && c();
                    var n = e.forwardToSlaves || e.forwardToReplicas ? "true" : "false",
                        s = this;
                    return this.as._jsonRequest({
                        method: "PUT",
                        url: "/1/indexes/" + encodeURIComponent(s.indexName) + "/settings?forwardToReplicas=" + n,
                        hostType: "write",
                        body: t,
                        callback: i
                    })
                    ...
                    return this.listApiKeys(t)
                }), a("index.listUserKeys()", "index.listApiKeys()")), i.prototype.listApiKeys = function(t) {
                    var e = this;
                    return this.as._jsonRequest({
                        method: "GET",
                    ...
                    return this.getApiKey(t, e)
                }), a("index.getUserKeyACL()", "index.getApiKey()")), i.prototype.getApiKey = function(t, e) {
                    var i = this;
                    return this.as._jsonRequest({
                        method: "GET",
                        url: "/1/indexes/" + encodeURIComponent(i.indexName) + "/keys/" + t,
                        hostType: "read",
                        callback: e
                    })
                }, i.prototype.deleteUserKey = r((function(t, e) {
                    return this.deleteApiKey(t, e)
                }), a("index.deleteUserKey()", "index.deleteApiKey()")), i.prototype.deleteApiKey = function(t, e) {
                    var i = this;
                    return this.as._jsonRequest({
                        method: "DELETE",
                        url: "/1/indexes/" + encodeURIComponent(i.indexName) + "/keys/" + t,
                    ...
                    return this.addApiKey(t, e, i)
                }), a("index.addUserKey()", "index.addApiKey()")), i.prototype.addApiKey = function(e, i, n) {
                    var s = "Usage: index.addApiKey(arrayOfAcls[, params, callback])";
                    if (!t(8)(e)) throw new Error(s);
                    1 !== arguments.length && "function" != typeof i || (n = i, i = null);
                    var o = {
                        acl: e
                    };
                    return i && (o.validity = i.validity, o.maxQueriesPerIPPerHour = i.maxQueriesPerIPPerHour, o.maxHitsPerQuery = i.maxHitsPerQuery, o.description = i.description, i.queryParameters && (o.queryParameters = this.as._getSearchParams(i.queryParameters, "")), o.referers = i.referers), this.as._jsonRequest({
                        method: "POST",
                    ...
                    return this.addApiKey(t, e, i)
                }), a("index.addUserKeyWithValidity()", "index.addApiKey()")), i.prototype.updateUserKey = r((function(t, e, i, n) {
                    return this.updateApiKey(t, e, i, n)
                }), a("index.updateUserKey()", "index.updateApiKey()")), i.prototype.updateApiKey = function(e, i, n, s) {
                    var o = "Usage: index.updateApiKey(key, arrayOfAcls[, params, callback])";
                    if (!t(8)(i)) throw new Error(o);
                    2 !== arguments.length && "function" != typeof n || (s = n, n = null);
                    var r = {
                        acl: i
                    };
                    return n && (r.validity = n.validity, r.maxQueriesPerIPPerHour = n.maxQueriesPerIPPerHour, r.maxHitsPerQuery = n.maxHitsPerQuery, r.description = n.description, n.queryParameters && (r.queryParameters = this.as._getSearchParams(n.queryParameters, "")), r.referers = n.referers), this.as._jsonRequest({
                        method: "PUT",
            ...
            17: [function(t, e) {
                ...
                function i() {}
                e.exports = i, t(7)(i, t(4).EventEmitter), i.prototype.stop = function() {
            ...
            18: [function(t, e) {
                ...
                var n = t(23),
                    s = t(25),
                    o = t(26);
                e.exports = i, i.prototype.clearCache = function() {
                    this.cache = {}
                }, i.prototype.search = n("query"), i.prototype.similarSearch = n("similarQuery"), i.prototype.browse = function(e, i, n) {
                    var s, o, r = t(30),
                        a = this;
                    0 === arguments.length || 1 === arguments.length && "function" == typeof arguments[0] ? (s = 0, n = arguments[0], e = void 0) : "number" == typeof arguments[0] ? (s = arguments[0], "number" == typeof arguments[1] ? o = arguments[1] : "function" == typeof arguments[1] && (n = arguments[1], o = void 0), e = void 0, i = void 0) : "object" == typeof arguments[0] ? ("function" == typeof arguments[1] && (n = arguments[1]), i = arguments[0], e = void 0) : "string" == typeof arguments[0] && "function" == typeof arguments[1] && (n = arguments[1], i = void 0), i = r({}, i || {}, {
                        page: s,
                        hitsPerPage: o,
                        query: e
                    });
                    ...
                    if (void 0 === e.facetName || void 0 === e.facetQuery) throw new Error(o);
                    var r = e.facetName,
                        a = s(n(e), (function(t) {
                            return "facetName" === t
                        })),
                    ...
                    return this.as._jsonRequest({
                        method: "POST",
                        url: "/1/indexes/" + encodeURIComponent(this.indexName) + "/facets/" + encodeURIComponent(r) + "/query",
                        hostType: "read",
                        body: {
                            params: h
                        },
                ...
                }), o("index.searchFacet(params[, callback])", "index.searchForFacetValues(params[, callback])")), i.prototype._search = function(t, e, i, n) {
                    return this.as._jsonRequest({
                        cache: this.cache,
                        method: "POST",
                    ...
                    if (void 0 !== e) {
                        s = "?attributes=";
                        for (var o = 0; o < e.length; ++o) 0 !== o && (s += ","), s += e[o]
                    }
                    return this.as._jsonRequest({
                        method: "GET",
                        url: "/1/indexes/" + encodeURIComponent(n.indexName) + "/" + encodeURIComponent(t) + s,
                        hostType: "read",
                        callback: i
                    })
                    ...
                    if (!s(e)) throw new Error(r);
                    var a = this;
                    1 !== arguments.length && "function" != typeof i || (n = i, i = void 0);
                    var h = {
                        requests: o(e, (function(t) {
                            var e = {
            ...
            20: [function(t, e) {
                (function(i) {
                    ...
                    e.exports = function(e, o) {
                        function r(e, i, n) {
                            return (n = t(24)(n || {}))._ua = n._ua || r.ua, new a(e, i, n)
                        }
                        ...
                        var h = t(7),
                            ...
                            u = t(22),
                            p = t(32);
                        o = o || "", "debug" === i.env.NODE_ENV && t(1).enable("algoliasearch*"), r.version = t(34), r.ua = "Algolia for vanilla JavaScript " + o + r.version, r.initPlaces = p(r), n.__algolia = {
                            debug: t(1),
                            algoliasearch: r
                        };
                        var d = {
                        ...
                        return d.hasXMLHttpRequest && (d.cors = "withCredentials" in new XMLHttpRequest), h(a, e), a.prototype._request = function(t, e) {
                            return new s((function(i, n) {
                                ...
                                function o(t) {
                                    f || (clearTimeout(p), n(new l.Network({
                                        more: t
                                    })))
                                }
                                ...
                                function a() {
                                    v = !0, clearTimeout(p), p = setTimeout(r, e.timeouts.complete)
                                }
            ...
            22: [function(t, e) {
                ...
                function i(t, e, i) {
                    function o() {
                        e.debug("JSONP: success"), g || p || (g = !0, u || (e.debug("JSONP: Fail. Script loaded but did not call the callback"), a(), i(new n.JSONPScriptFail)))
                    }
                    ...
                    function l() {
                        e.debug("JSONP: Script timeout"), p = !0, a(), i(new n.RequestTimeout)
                    }

                    function c() {
                        e.debug("JSONP: Script error"), g || p || (a(), i(new n.JSONPScriptError))
                    }
                    if ("GET" === e.method) {
                        e.debug("JSONP: start");
                        var u = !1,
                        ...
                        var d = document.getElementsByTagName("head")[0],
                            ...
                            g = !1;
                        window[m] = function(t) {
                            return h(), p ? void e.debug("JSONP: Late answer, ignoring") : (u = !0, a(), void i(null, {
                                body: t
                            }))
                        }, t += "&callback=" + m, e.jsonBody && e.jsonBody.params && (t += "&" + e.jsonBody.params);
                        var v = setTimeout(l, e.timeouts.complete);
                        f.onreadystatechange = r, f.onload = o, f.onerror = c, f.async = !0, f.defer = !0, f.src = t, d.appendChild(f)
                    } else i(new Error("Method " + e.method + " " + t + " is not supported by JSONP."))
                }
                e.exports = i;
                var n = t(27),
                    s = 0
            ...
            23: [function(t, e) {
                function i(t, e) {
                    return function(i, s, o) {
                        if ("function" == typeof i && "object" == typeof s || "object" == typeof o) throw new n.AlgoliaSearchError("index.search usage is index.search(query, params, cb)");
                        0 === arguments.length || "function" == typeof i ? (o = i, i = "") : 1 !== arguments.length && "function" != typeof s || (o = s, s = void 0), "object" == typeof i && null !== i ? (s = i, i = void 0) : null != i || (i = "");
                        var r, a = "";
                        return void 0 !== i && (a += t + "=" + encodeURIComponent(i)), void 0 !== s && (s.additionalUA && (r = s.additionalUA, delete s.additionalUA), a = this.as._getSearchParams(s, a)), this._search(a, e, o, r)
                    }
                }
                e.exports = i;
                var n = t(27)
            ...
            26: [function(t, e) {
                e.exports = function(t, e) {
                    var i = t.toLowerCase().replace(/[\.\(\)]/g, "");
                    return "algoliasearch: `" + t + "` was replaced by `" + e + "`. Please see https://github.com/algolia/algoliasearch-client-javascript/wiki/Deprecated#" + i
                }
            }, {}],
            27: [function(t, e) {
                "use strict";
                ...
                function i(e, i) {
                    var n = t(5),
                        s = this;
                    "function" == typeof Error.captureStackTrace ? Error.captureStackTrace(this, this.constructor) : s.stack = (new Error).stack || "Cannot get a stacktrace, browser is too old", this.name = "AlgoliaSearchError", this.message = e || "Unknown error", i && n(i, (function(t, e) {
                        s[e] = t
                    }))
                }
            ...
            30: [function(t, e) {
                ...
                e.exports = function t(e) {
                    ...
                    return i(n, (function(i) {
                        for (var n in i) i.hasOwnProperty(n) && ("object" == typeof e[n] && "object" == typeof i[n] ? e[n] = t({}, e[n], i[n]) : void 0 !== i[n] && (e[n] = i[n]))
                    })), e
                }
            }, {
                5: 5
            ...
            32: [function(t, e) {
                function i(e) {
                    return function(i, s, o) {
                        var r = t(24);
                        (o = o && r(o) || {}).hosts = o.hosts || ["places-dsn.algolia.net", "places-1.algolianet.com", "places-2.algolianet.com", "places-3.algolianet.com"], 0 !== arguments.length && "object" != typeof i && void 0 !== i || (i = "", s = "", o._allowEmptyCredentials = !0);
                        var a = e(i, s, o).initIndex("places");
                        return a.search = n("query", "/1/places/query"), a.getObject = function(t, e) {
                            return this.as._jsonRequest({
                                method: "GET",
            ...
            33: [function(t, e) {
                (function(i) {
                    ...
                    function o() {
                        try {
                            return "localStorage" in i && null !== i.localStorage && (i.localStorage[l] || i.localStorage.setItem(l, JSON.stringify({})), !0)
                        } catch (t) {
                            return !1
                        }
                    }
                    ...
                    var a, h = t(1)("algoliasearch:src/hostIndexState.js"),
                        ...
                        u = {
                            set: function(t, e) {
                                ...
                                try {
                                    ...
                                    return s[t] = e, i.localStorage[l] = JSON.stringify(s), s[t]
                                } catch (e) {
                                    return n(t, e)
                                }
                            },
    ...
    function(t) {
        ...
        n.element = s;
        var o = i(4);
        o.isArray = s.isArray, o.isFunction = s.isFunction, o.isObject = s.isPlainObject, o.bind = s.proxy, o.each = function(t, e) {
            function i(t, i) {
                return e(i, t)
            }
            s.each(t, i)
        }, o.map = s.map, o.mixin = s.extend, o.Event = s.Event;
        var r, a, h, l = i(5),
            c = i(6);
        r = s.fn.autocomplete, a = "aaAutocomplete", h = {
            initialize: function(t, e) {
                ...
                return e = o.isArray(e) ? e : [].slice.call(arguments, 1), t = t || {}, this.each(i)
            },
            open: function() {
                function t() {
                    var t;
            ...
            val: function(t) {
                ...
                return arguments.length ? this.each(e) : function(t) {
                    var e, i;
            ...
            var e;
            return h[t] && "initialize" !== t ? (e = this.filter((function() {
                return !!s(this).data(a)
            })), h[t].apply(e, [].slice.call(arguments, 1))) : h.initialize.apply(this, arguments)
        }, s.fn.autocomplete.noConflict = function() {
            return s.fn.autocomplete = r, this
        }, s.fn.autocomplete.sources = l.sources, s.fn.autocomplete.escapeHighlightedString = o.escapeHighlightedString, t.exports = s.fn.autocomplete
    }, function(t) {
        "use strict";
        t.exports = {
            element: null
        ...
        t.exports = {
            ...
            cloneDeep: function(t) {
                var e = this.mixin({}, t),
                    i = this;
                return this.each(e, (function(t, n) {
                    t && (i.isArray(t) ? e[n] = [].concat(t) : i.isObject(t) && (e[n] = i.cloneDeep(t)))
                })), e
            },
            error: function(t) {
                throw new Error(t)
            ...
            every: function(t, e) {
                var i = !0;
                return t ? (this.each(t, (function(n, s) {
                    i && (i = e.call(null, n, s, t) && i)
                })), !!i) : i
            },
            any: function(t, e) {
                var i = !1;
            ...
            escapeHighlightedString: function(t, e, i) {
                ...
                return r.appendChild(document.createTextNode(t)), r.innerHTML.replace(RegExp(n(s.innerHTML), "g"), e).replace(RegExp(n(o.innerHTML), "g"), i)
            }
        }
    }, function(t, e, i) {
        "use strict";
        ...
        function n(t) {
            var e, i;
            if ((t = t || {}).input || h.error("missing input"), this.isActivated = !1, this.debug = !!t.debug, this.autoselect = !!t.autoselect, this.autoselectOnBlur = !!t.autoselectOnBlur, this.openOnFocus = !!t.openOnFocus, this.minLength = h.isNumber(t.minLength) ? t.minLength : 1, this.autoWidth = void 0 === t.autoWidth || !!t.autoWidth, this.clearOnSelected = !!t.clearOnSelected, this.tabAutocomplete = void 0 === t.tabAutocomplete || !!t.tabAutocomplete, t.hint = !!t.hint, t.hint && t.appendTo) throw new Error("[autocomplete.js] hint and appendTo options can't be used at the same time");
            this.css = t.css = h.mixin({}, f, t.appendTo ? f.appendTo : {}), this.cssClasses = t.cssClasses = h.mixin({}, f.defaultClasses, t.cssClasses || {}), this.cssClasses.prefix = t.cssClasses.formattedPrefix = h.formatPrefix(this.cssClasses.prefix, this.cssClasses.noPrefix), this.listboxId = t.listboxId = [this.cssClasses.root, "listbox", h.getUniqueId()].join("-");
            var o = s(t);
            this.$node = o.wrapper;
            var r = this.$input = o.input;
            e = o.menu, i = o.hint, t.dropdownMenuContainer && l.element(t.dropdownMenuContainer).css("position", "relative").append(e.css("top", "0")), r.on("blur.aa", (function(t) {
                var i = document.activeElement;
                h.isMsie() && (e[0] === i || e[0].contains(i)) && (t.preventDefault(), t.stopImmediatePropagation(), h.defer((function() {
                    r.focus()
                })))
            })), e.on("mousedown.aa", (function(t) {
                t.preventDefault()
            })), this.eventBus = t.eventBus || new c({
                el: r
            ...
            }).onSync("suggestionClicked", this._onSuggestionClicked, this).onSync("cursorMoved", this._onCursorMoved, this).onSync("cursorRemoved", this._onCursorRemoved, this).onSync("opened", this._onOpened, this).onSync("closed", this._onClosed, this).onSync("shown", this._onShown, this).onSync("empty", this._onEmpty, this).onSync("redrawn", this._onRedrawn, this).onAsync("datasetRendered", this._onDatasetRendered, this), this.input = new n.Input({
                input: r,
                hint: i
        ...
        function s(t) {
            var e, i, n, s;
            e = l.element(t.input), i = l.element(d.wrapper.replace("%ROOT%", t.cssClasses.root)).css(t.css.wrapper), t.appendTo || "block" !== e.css("display") || "table" !== e.parent().css("display") || i.css("display", "table-cell");
            var r = d.dropdown.replace("%PREFIX%", t.cssClasses.prefix).replace("%DROPDOWN_MENU%", t.cssClasses.dropdownMenu);
            n = l.element(r).css(t.css.dropdown).attr({
                role: "listbox",
                id: t.listboxId
            }), t.templates && t.templates.dropdownMenu && n.html(h.templatify(t.templates.dropdownMenu)()), (s = e.clone().css(t.css.hint).css(o(e))).val("").addClass(h.className(t.cssClasses.prefix, t.cssClasses.hint, !0)).removeAttr("id name placeholder required").prop("readonly", !0).attr({
                "aria-hidden": "true",
                autocomplete: "off",
                spellcheck: "false",
                tabindex: -1
            }), s.removeData && s.removeData(), e.data(a, {
                ...
                style: e.attr("style"),
                type: e.attr("type")
            }), e.addClass(h.className(t.cssClasses.prefix, t.cssClasses.input, !0)).attr({
                autocomplete: "off",
                spellcheck: !1,
                role: "combobox",
            ...
            return (i = t.appendTo ? i.appendTo(l.element(t.appendTo).eq(0)).eq(0) : e.wrap(i).parent()).prepend(t.hint ? s : null).append(n), {
                wrapper: i,
                input: e,
                hint: s,
                menu: n
        ...
        function r(t, e) {
            ...
            })), i.detach().removeClass(h.className(e.prefix, e.input, !0)).insertAfter(t), i.removeData && i.removeData(a), t.remove()
        }
        var a = "aaAttrs",
            h = i(4),
            l = i(2),
        ...
        h.mixin(n.prototype, {
            _bindKeyboardShortcuts: function(t) {
                if (t.keyboardShortcuts) {
                    ...
                    h.each(t.keyboardShortcuts, (function(t) {
                        "string" == typeof t && (t = t.toUpperCase().charCodeAt(0)), i.push(t)
                    })), l.element(document).keydown((function(t) {
                        var n = t.target || t.srcElement,
                            s = n.tagName;
                        if (!n.isContentEditable && "INPUT" !== s && "SELECT" !== s && "TEXTAREA" !== s) {
                            var o = t.which || t.keyCode; - 1 !== i.indexOf(o) && (e.focus(), t.stopPropagation(), t.preventDefault())
                        }
                    }))
                }
            },
            _onSuggestionClicked: function(t, e) {
                ...
                (i = this.dropdown.getDatumForSuggestion(e)) && this._select(i, n)
            },
            _onCursorMoved: function(t, e) {
                var i = this.dropdown.getDatumForCursor(),
                    n = this.dropdown.getCurrentCursor().attr("id");
                this.input.setActiveDescendant(n), i && (e && this.input.setInputValue(i.value, !0), this.eventBus.trigger("cursorchanged", i.raw, i.datasetName))
            },
            ...
            _onBlurred: function() {
                ...
                this.debug || (this.autoselectOnBlur && t ? this._select(t, i) : this.autoselectOnBlur && e ? this._select(e, i) : (this.isActivated = !1, this.dropdown.empty(), this.dropdown.close()))
            },
            _onEnterKeyed: function(t, e) {
                var i, n;
                i = this.dropdown.getDatumForCursor(), n = this.dropdown.getDatumForTopSuggestion();
                var s = {
                    selectionMethod: "enterKey"
                };
                i ? (this._select(i, s), e.preventDefault()) : this.autoselect && n && (this._select(n, s), e.preventDefault())
            },
            _onTabKeyed: function(t, e) {
                if (this.tabAutocomplete) {
                    ...
                    (i = this.dropdown.getDatumForCursor()) ? (this._select(i, n), e.preventDefault()) : this._autocomplete(!0)
            ...
            _updateHint: function() {
                var t, e, i, n, s;
                (t = this.dropdown.getDatumForTopSuggestion()) && this.dropdown.isVisible() && !this.input.hasOverflow() ? (e = this.input.getInputValue(), i = u.normalizeQuery(e), n = h.escapeRegExChars(i), (s = new RegExp("^(?:" + n + ")(.+$)", "i").exec(t.value)) ? this.input.setHint(e + s[1]) : this.input.clearHint()) : this.input.clearHint()
            },
            _autocomplete: function(t) {
                var e, i, n, s;
                e = this.input.getHint(), i = this.input.getQuery(), n = t || this.input.isCursorAtEnd(), e && i !== e && n && ((s = this.dropdown.getDatumForTopSuggestion()) && this.input.setInputValue(s.value), this.eventBus.trigger("autocompleted", s.raw, s.datasetName))
            },
            _select: function(t, e) {
                void 0 !== t.value && this.input.setQuery(t.value), this.clearOnSelected ? this.setVal("") : this.input.setInputValue(t.value, !0), this._setLanguageDirection(), !1 === this.eventBus.trigger("selected", t.raw, t.datasetName, e).isDefaultPrevented() && (this.dropdown.close(), h.defer(h.bind(this.dropdown.empty, this.dropdown)))
            },
            open: function() {
                if (!this.isActivated) {
            ...
            setVal: function(t) {
                t = h.toStr(t), this.isActivated ? this.input.setInputValue(t) : (this.input.setQuery(t), this.input.setInputValue(t, !0)), this._setLanguageDirection()
            },
            getVal: function() {
        ...
        }), n.Dropdown = p, n.Input = u, n.sources = i(20), t.exports = n
    }, function(t, e, i) {
        "use strict";

        function n(t) {
            t && t.el || s.error("EventBus initialized without el"), this.$el = o.element(t.el)
        }
        var s = i(4),
            o = i(2);
        s.mixin(n.prototype, {
            trigger: function(t, e, i, n) {
                var o = s.Event("autocomplete:" + t);
                return this.$el.trigger(o, [e, i, n]), o
            }
        }), t.exports = n
    }, function(t, e, i) {
        "use strict";
        ...
        function n(t) {
            var e, i, n, o, r = this;
            (t = t || {}).input || h.error("input is missing"), e = h.bind(this._onBlur, this), i = h.bind(this._onFocus, this), n = h.bind(this._onKeydown, this), o = h.bind(this._onInput, this), this.$hint = l.element(t.hint), this.$input = l.element(t.input).on("blur.aa", e).on("focus.aa", i).on("keydown.aa", n), 0 === this.$hint.length && (this.setHint = this.getHint = this.clearHint = this.clearHintIfInvalid = h.noop), h.isMsie() ? this.$input.on("keydown.aa keypress.aa cut.aa paste.aa", (function(t) {
                a[t.which || t.keyCode] || h.defer(h.bind(r._onInput, r, t))
            })) : this.$input.on("input.aa", o), this.query = this.$input.val(), this.$overflowHelper = s(this.$input)
        }

        function s(t) {
            return l.element('<pre aria-hidden="true"></pre>').css({
                position: "absolute",
                visibility: "hidden",
                whiteSpace: "pre",
        ...
        n.normalizeQuery = function(t) {
            ...
            _managePreventDefault: function(t, e) {
                ...
                switch (t) {
                    case "tab":
                        n = this.getHint(), s = this.getInputValue(), i = n && n !== s && !r(e);
                        break;
                    case "up":
                    case "down":
                        i = !r(e);
            ...
            _checkInputValue: function() {
                var t, e, i;
                i = !(!(e = o(t = this.getInputValue(), this.query)) || !this.query) && this.query.length !== t.length, this.query = t, e ? i && this.trigger("whitespaceChanged", this.query) : this.trigger("queryChanged", this.query)
            },
            focus: function() {
                this.$input.focus()
            },
            ...
            isCursorAtEnd: function() {
                var t, e, i;
                return t = this.$input.val().length, e = this.$input[0].selectionStart, h.isNumber(e) ? e === t : !document.selection || ((i = document.selection.createRange()).moveStart("character", -t), t === i.text.length)
            },
            destroy: function() {
        ...
        function n(t, e, i, n) {
            var s;
            if (!i) return this;
            for (e = e.split(u), i = n ? l(i, n) : i, this._callbacks = this._callbacks || {}; s = e.shift();) this._callbacks[s] = this._callbacks[s] || {
                sync: [],
                async: []
        ...
        function a(t) {
            var e, i, n, s, o;
            if (!this._callbacks) return this;
            for (t = t.split(u), n = [].slice.call(arguments, 1);
                (e = t.shift()) && (i = this._callbacks[e]);) s = h(i.sync, this, [e].concat(n)), o = h(i.async, this, [e].concat(n)), s() && c(o);
            return this
        }

        function h(t, e, i) {
            function n() {
                for (var n, s = 0, o = t.length; !n && s < o; s += 1) n = !1 === t[s].apply(e, i);
                return !n
            }
            return n
        }
        ...
        function n() {
            a && h && (a = !1, h.length ? p = h.concat(p) : u = -1, p.length && s())
        }
        ...
        for (var a, h, l, c = [i(10), i(12), i(13), i(14), i(15)], u = -1, p = [], d = !1, f = -1, m = c.length; ++f < m;)
        ...
        function n(t) {
            ...
            if ((l === e || !l) && setTimeout) return l = setTimeout, setTimeout(t, 0);
            try {
                return l(t, 0)
            } catch (e) {
                try {
        ...
        function o() {
            f && p && (f = !1, p.length ? d = p.concat(d) : m = -1, d.length && r())
        }
        ...
        u.nextTick = function(t) {
            ...
            this.fun.apply(null, this.array)
        }, u.title = "browser", u.browser = !0, u.env = {}, u.argv = [], u.version = "", u.versions = {}, u.on = h, u.addListener = h, u.once = h, u.off = h, u.removeListener = h, u.removeAllListeners = h, u.emit = h, u.binding = function() {
            throw new Error("process.binding is not supported")
        }, u.cwd = function() {
            return "/"
        }, u.chdir = function() {
        ...
        function n(t) {
            var e, i, n, a = this;
            (t = t || {}).menu || o.error("menu is required"), o.isArray(t.datasets) || o.isObject(t.datasets) || o.error("1 or more datasets required"), t.datasets || o.error("datasets is required"), this.isOpen = !1, this.isEmpty = !0, this.minLength = t.minLength || 0, this.templates = {}, this.appendTo = t.appendTo || !1, this.css = o.mixin({}, l, t.appendTo ? l.appendTo : {}), this.cssClasses = t.cssClasses = o.mixin({}, l.defaultClasses, t.cssClasses || {}), this.cssClasses.prefix = t.cssClasses.formattedPrefix || o.formatPrefix(this.cssClasses.prefix, this.cssClasses.noPrefix), e = o.bind(this._onSuggestionClick, this), i = o.bind(this._onSuggestionMouseEnter, this), n = o.bind(this._onSuggestionMouseLeave, this);
            var h = o.className(this.cssClasses.prefix, this.cssClasses.suggestion);
            this.$menu = r.element(t.menu).on("mouseenter.aa", h, i).on("mouseleave.aa", h, n).on("click.aa", h, e), this.$container = t.appendTo ? t.wrapper : this.$menu, t.templates && t.templates.header && (this.templates.header = o.templatify(t.templates.header), this.$menu.prepend(this.templates.header())), t.templates && t.templates.empty && (this.templates.empty = o.templatify(t.templates.empty), this.$empty = r.element('<div class="' + o.className(this.cssClasses.prefix, this.cssClasses.empty, !0) + '"></div>'), this.$menu.append(this.$empty), this.$empty.hide()), this.datasets = o.map(t.datasets, (function(e) {
        ...
        o.mixin(n.prototype, a, {
            ...
            _onSuggestionMouseLeave: function(t) {
                t.relatedTarget && r.element(t.relatedTarget).closest("." + o.className(this.cssClasses.prefix, this.cssClasses.cursor, !0)).length > 0 || (this._removeCursor(), this.trigger("cursorRemoved"))
            },
            _onRendered: function(t, e) {
                ...
                else o.any(this.datasets, n) ? e.length < this.minLength ? this._hide() : this._show() : this._hide();
            ...
            _moveCursor: function(t) {
                var e, i, n, s;
                if (this.isOpen) {
                    if (i = this._getCursor(), e = this._getSuggestions(), this._removeCursor(), -1 == (n = ((n = e.index(i) + t) + 1) % (e.length + 1) - 1)) return void this.trigger("cursorRemoved");
                    n < -1 && (n = e.length - 1), this._setCursor(s = e.eq(n), !0), this._ensureVisible(s)
                }
            },
            _ensureVisible: function(t) {
                var e, i, n, s;
                i = (e = t.position().top) + t.height() + parseInt(t.css("margin-top"), 10) + parseInt(t.css("margin-bottom"), 10), n = this.$menu.scrollTop(), s = this.$menu.height() + parseInt(this.$menu.css("padding-top"), 10) + parseInt(this.$menu.css("padding-bottom"), 10), e < 0 ? this.$menu.scrollTop(n + e) : s < i && this.$menu.scrollTop(n + (i - s))
            },
            close: function() {
        ...
        }), n.Dataset = h, t.exports = n
    }, function(t, e, i) {
        "use strict";

        function n(t) {
            (t = t || {}).templates = t.templates || {}, t.source || c.error("missing source"), t.name && !r(t.name) && c.error("invalid dataset name: " + t.name), this.query = null, this._isEmpty = !0, this.highlight = !!t.highlight, this.name = void 0 === t.name || null === t.name ? c.getUniqueId() : t.name, this.source = t.source, this.displayFn = s(t.display || t.displayKey), this.debounce = t.debounce, this.cache = !1 !== t.cache, this.templates = o(t.templates, this.displayFn), this.css = c.mixin({}, d, t.appendTo ? d.appendTo : {}), this.cssClasses = t.cssClasses = c.mixin({}, d.defaultClasses, t.cssClasses || {}), this.cssClasses.prefix = t.cssClasses.formattedPrefix || c.formatPrefix(this.cssClasses.prefix, this.cssClasses.noPrefix);
            var e = c.className(this.cssClasses.prefix, this.cssClasses.dataset);
            this.$el = t.$menu && t.$menu.find(e + "-" + this.name).length > 0 ? u.element(t.$menu.find(e + "-" + this.name)[0]) : u.element(p.dataset.replace("%CLASS%", this.name).replace("%PREFIX%", this.cssClasses.prefix).replace("%DATASET%", this.cssClasses.dataset)), this.$menu = t.$menu, this.clearCachedSuggestions()
        }
            ...
            _render: function(t, e) {
                function i() {
                    ...
                    return e = [{
                        query: t,
                        isEmpty: !0
                    }].concat(e), d.templates.empty.apply(this, e)
                }

                function n() {
                    function t(t) {
                        var e, i = p.suggestion.replace("%PREFIX%", o.cssClasses.prefix).replace("%SUGGESTION%", o.cssClasses.suggestion);
                        return (e = u.element(i).attr({
                            role: "option",
                            id: ["option", Math.floor(1e8 * Math.random())].join("-")
                        }).append(d.templates.suggestion.apply(this, [t].concat(s)))).data(a, d.name), e.data(h, d.displayFn(t) || void 0), e.data(l, JSON.stringify(t)), e.children().each((function() {
                            u.element(this).css(o.css.suggestionChild)
                        })), e
                    }
                    var i, n, s = [].slice.call(arguments, 0),
                        o = this,
                        r = p.suggestions.replace("%PREFIX%", this.cssClasses.prefix).replace("%SUGGESTIONS%", this.cssClasses.suggestions);
                    return i = u.element(r).css(this.css.suggestions), n = c.map(e, t), i.append.apply(i, n), i
                }
                ...
                function s() {
                    ...
                    return e = [{
                        query: t,
                        isEmpty: !r
                    }].concat(e), d.templates.header.apply(this, e)
                }
                ...
                function o() {
                    ...
                    return e = [{
                        query: t,
                        isEmpty: !r
                    }].concat(e), d.templates.footer.apply(this, e)
                }
                if (this.$el) {
                    var r, d = this,
                        f = [].slice.call(arguments, 2);
                    if (this.$el.empty(), r = e && e.length, this._isEmpty = !r, !r && this.templates.empty) this.$el.html(i.apply(this, f)).prepend(d.templates.header ? s.apply(this, f) : null).append(d.templates.footer ? o.apply(this, f) : null);
                    else if (r) this.$el.html(n.apply(this, f)).prepend(d.templates.header ? s.apply(this, f) : null).append(d.templates.footer ? o.apply(this, f) : null);
            ...
            update: function(t) {
                function e(e) {
                    if (!this.canceled && t === this.query) {
                        ...
                        this.cacheSuggestions(t, e, i), this._render.apply(this, [t, e].concat(i))
                    }
                }
                if (this.query = t, this.canceled = !1, this.shouldFetchFromCache(t)) e.apply(this, [this.cachedSuggestions].concat(this.cachedRenderExtraArgs));
                    ...
                    var i = this,
                        n = function() {
                            i.canceled || i.source(t, e.bind(i))
                        };
                    if (this.debounce) {
                        var s = function() {
                            i.debounceTimeout = null, n()
                        };
                        clearTimeout(this.debounceTimeout), this.debounceTimeout = setTimeout(s, this.debounce)
                    } else n()
                }
            },
            cacheSuggestions: function(t, e, i) {
                this.cachedQuery = t, this.cachedSuggestions = e, this.cachedRenderExtraArgs = i
            },
        ...
        n.isMsie() && n.mixin(s.input, {
            backgroundImage: "url(data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7)"
        }), n.isMsie() && n.isMsie() <= 7 && n.mixin(s.input, {
            marginTop: "-1px"
        }), t.exports = s
    }, function(t, e, i) {
        "use strict";
        ...
        t.exports = function(t, e) {
            ...
            var r = o(t.as._ua);
            return r && r[0] >= 3 && r[1] > 20 && ((e = e || {}).additionalUA = "autocomplete.js " + s), i
        }
    }, function(t) {
        t.exports = "0.37.1"
    }, function(t) {
        ...
        t.exports = function(t, e, i, r) {
                ...
                t.search(a, e, (function(t, a) {
                    if (t) n.error(t.message);
                        ...
                        if (a.hits.length > 0) {
                            ...
                            var d = o(c.as._ua);
                            return d && d[0] >= 3 && d[1] > 20 && (e.additionalUA = "autocomplete.js " + s), void c.search(l(u), p, (function(t, e) {
                                if (t) n.error(t.message);
                                else {
                                    var i = [];
                                    if (r.includeAll) {
            ...
            var h = o(t.as._ua);
            if (h && h[0] >= 3 && h[1] > 20 && ((e = e || {}).additionalUA = "autocomplete.js " + s), !i.source) return n.error("Missing 'source' key");
            var l = n.isFunction(i.source) ? i.source : function(t) {
                return t[i.source]
            };
        ...
        _fetchAndCache: function(t) {
            $.ajax({
                ...
                success: e => {
                    var i = e;
                    "function" == typeof t.createCacheableResult && (i = t.createCacheableResult(e)), this._inMemoryStore[t.key] = i, t.onSuccess(i)
                }
            })
        }
    }, window.IDGenerator = {
        length: 8,
        generate: function() {
            for (var t = [...Date.now().toString()].reverse(), e = "", i = 0; i < this.length; ++i) {
    ...
    function() {
        ...
        this.Class = function() {}, Class.extend = function(i) {
            function n() {
                !t && this.init && Reflect.apply(this.init, this, arguments)
            }
            var s = this.prototype;
            t = !0;
            var o = new this;
            for (var r in t = !1, i) o[r] = "function" == typeof i[r] && "function" == typeof s[r] && e.test(i[r]) ? function(t, e) {
                return function() {
                    var i = this._super;
                    this._super = s[t];
                    var n = Reflect.apply(e, this, arguments);
        ...
        function t(t) {
            ...
            return t.shiftKey && 16 !== t.keyCode && e.push(16), t.ctrlKey && 17 !== t.keyCode && e.push(17), t.altKey && 18 !== t.keyCode && e.push(18), t.metaKey && 91 !== t.keyCode && e.push(91), e.sort(), e.join("+")
        }
        ...
        function i(t) {
            for (var i = t.split("+"), n = [], s = 0; s < i.length; s++) n.push(e(i[s]));
            return n.sort(), n.join("+")
        }

        function n(t) {
            for (var e = [], n = t.split(","), s = 0; s < n.length; s++) e.push(i(n[s]));
            return e
        }
        ...
        return -1 !== navigator.appVersion.indexOf("Mac") && (h.comctrl = 91), $(document).on("keydown", o), {
            bind: function(t, e, i) {
                for (var s = n(t), o = s.length - 1; o >= 0; o--) jQuery.isArray(r[s[o]]) || (r[s[o]] = []), r[s[o]].push(e), a[s[o]] = !!i
            },
